...
- Name: visual\visual-regression.spec.ts >> Visual Regression - UI Components @visual >> Dashboard sidebar navigation should match visual baseline @visual
- Location: tests\visual\visual-regression.spec.ts:34:7
...
Call log:
  - waiting for locator('[class*="sidebar"]').first() to be visible
